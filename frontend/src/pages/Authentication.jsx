  ...
  return (
    <div className='flex flex-col items-center w-screen bg-[#1a1a1a]'>
        ...
        <div className='flex flex-col items-center gap-3 w-full tracking-[0.5px] py-1'>
            ...
            <input className='flex flex-row w-[90%] text-white bg-[#333333] h-9 rounded-lg gap-3 placeholder-[#b3b3b3] font-inter font-[400] text-sm px-2' type="email" placeholder='you@youremail.com' value={email} onChange={(e) => {setEmail(e.target.value)}}/>
        </div>
        <div className='flex flex-col items-center gap-3 w-full tracking-[0.5px] py-3 mb-3'>
            ...
            <input className='flex flex-row w-[90%] text-white bg-[#333333] h-9 rounded-lg gap-3 placeholder-[#b3b3b3] font-inter font-[400] text-sm px-2' type="password" placeholder='At least 8 characters.' value={password} onChange={(e) => {setPassword(e.target.value)}}/>
        </div>
