...
const UpdateProfession = () => {
    ...
    const [error, setError] = React.useState('Profession should only contain a-z, A-Z and space.')
  ...
  return (
    <div className='w-full h-full bg-[#1a1a1a] flex flex-col items-center'>
        <div className='flex flex-col items-center justify-center w-[90%] gap-1 py-10'> 
            ...
            <div className='text-left w-full'>
                <p className='font-inter font-[400] text-[#b3b3b3] text-base tracking-[0.5px]'>Your profession will be visible on our profile card.</p>
            </div>
        </div>
